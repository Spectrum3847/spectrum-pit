...
import 'package:spectrumpit/src/services/central_approval_check.dart';
import 'package:spectrumpit/src/services/central_auth_client.dart';
import 'package:spectrumpit/src/services/central_platform_config.dart';
...
void main() {
  ...
  test(
    ...
    () async {
      ...
      expect(service.currentUser?.uid, 'central-uid-1');
      expect(client.handshakeApps, <String>['spectrumpit']);
  ...
  group('daily central approval re-check', () {
    ...
    test('a restored session re-checks when a day has passed', () async {
      ...
      expect(client.handshakeApps, ['spectrumpit']);
      expect(service.snapshot.state, SpectrumAuthState.signedIn);
      await service.dispose();
    });
