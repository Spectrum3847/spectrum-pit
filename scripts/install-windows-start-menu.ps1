# Creates or removes a Start Menu shortcut for Spectrum Pit.
...
$exePath = Join-Path $scriptDir "spectrumpit.exe"

if (-not (Test-Path $exePath -PathType Leaf)) {
  Write-Warning "spectrumpit.exe not found next to the script at: $exePath"
...
$shortcut.Description = "Spectrum Pit"
$shortcut.Save()
